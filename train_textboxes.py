...
from textboxes import build_tb
import os
import sys
import time
import torch
...
parser.add_argument('--dataset', default='TEXTBOXES', choices=['TEXTBOXES'],
                    type=str, help='TEXTBOXES')
parser.add_argument('--dataset_root', default=CARPLATE_ROOT,
...
parser.add_argument('--obj_type', default='textboxes', choices=['textboxes'],
                    type=str, help='textboxes')
