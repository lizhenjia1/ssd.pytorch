...
from layers.modules import MultiBoxLoss, MultiBoxLoss_four_corners
...
parser.add_argument('--dataset', default='VOC', choices=['VOC', 'COCO', 'CARPLATE_FOUR_CORNERS'],
...
def train():
    ...
    elif args.dataset == 'CARPLATE_FOUR_CORNERS':
    ...
    for iteration in range(args.start_iter, cfg['max_iter']):
        ...
        if args.visdom:
            update_vis_plot(iteration, loss_l.data[0], loss_c.data[0], loss_four_corners.data[0], iter_plot, epoch_plot, 'append')
