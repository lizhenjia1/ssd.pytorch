...
parser.add_argument('--dataset', default='CARPLATE_FOUR_CORNERS_WITH_BORDER', choices=['CARPLATE_FOUR_CORNERS_WITH_BORDER'],
                    type=str, help='CARPLATE_FOUR_CORNERS_WITH_BORDER')
...
parser.add_argument('--obj_type', default='carplate_four_corners_with_border', choices=['carplate_four_corners_with_border'],
                    type=str, help='carplate_four_corners_with_border')
...
def train():
    ...
    for iteration in range(args.start_iter, cfg['max_iter']):
        ...
        if iteration % 100 == 0:
            log.l.info('''
                Timer: {:.5f} sec.\t LR: {}.\t Iter: {}.\t Loss_l: {:.5f}.\t Loss_c: {:.5f}.\t Loss_four_corners: {:.5f}.\t Loss_border: {:.5f}.\t Loss: {:.5f}.
                '''.format((t1-t0), lr, iteration, loss_l.item(), loss_c.item(), loss_four_corners.item(), loss_border.item(),
                loss_l.item() + loss_c.item() + loss_four_corners.item() + loss_border.item()))

        if args.visdom:
            update_vis_plot(iteration, loss_l.item(), loss_c.item(), loss_four_corners.item(), loss_border.item(),
