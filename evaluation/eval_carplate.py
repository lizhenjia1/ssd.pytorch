...
from data import CARPLATEDetection, CARPLATEAnnotationTransform, CARPLATE_ROOT, BaseTransform
...
def test_net(save_folder, net, cuda, dataset, transform, top_k,
    ...
    output_dir = get_output_dir('ssd' + str(args.input_size) + '_carplate', set_type)
...
if __name__ == '__main__':
    ...
    dataset = CARPLATEDetection(root=args.voc_root,
                           ...
                           target_transform=CARPLATEAnnotationTransform(),
